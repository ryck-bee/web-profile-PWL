...
if (isset($_POST["submit"])) {
  ...
  if (buat($_POST) > 0) {
    ...
    echo "
    <script>
    alert('Succses Register Account !');
        ...
        <div class="row">
          ...
          <div class="col-auto">
            ...
            <ul class="social-media">
              <li ><a href="login.php" style=""><span class="text-success">Login</span></a></li>
            </ul>
          </div>
        </div>
      </div> 
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="text-black h1 site-section-heading">Other</h2>
          </div>
        </div>
        <div class="row">
            ...
            <form action="" method="POST" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" required="required" id="fname" class="form-control" name="username">
                </div>
                <div class="col-md-6">
                  <label class="text-black" for="email">Email</label>
                  <input type="email" required="required" id="lname" class="form-control" name="email">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  <label class="text-black" for="password">Repeat Password</label> 
                  <input type="password" required="required" id="password" class="form-control" name="password2">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="create" value="Register" class="btn btn-success btn-md text-white">
                </div>
              </div>
